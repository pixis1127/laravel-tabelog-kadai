                 ...
                 <div class="col-md-7 mt-2">
                     <div class="d-inline-flex">
                         ...
                         <div class="container mt-3">
                             ...
                             <h7 class="w-100 kadai_002-reservation-item-text">{{ $reservation->reservation_day->reservation_day }}</h7>
                             <h8 class="w-100 kadai_002-reservation-item-text">{{ $reservation->reservation_time->reservation_time }}</h8>
                         </div>
                     </div>
                 </div>
